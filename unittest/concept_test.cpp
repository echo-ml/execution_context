...
TEST_CASE("concept") {
  ...
  REQUIRE(execution_context::concept::flat_evaluator_expression<decltype(expr1)>());
  REQUIRE(
  ...
  REQUIRE(!execution_context::concept::flat_evaluator_expression<decltype(expr2)>());
  REQUIRE(
  ...
  REQUIRE(
      execution_context::concept::flat_evaluator_reduction_expression<decltype(expr3)>());
  REQUIRE(!execution_context::concept::flat_evaluator_expression<decltype(expr3)>());
  ...
  auto expr4 = make_reduction_expression(
      ...
      std::plus<double>(), 0.0);
  REQUIRE(execution_context::concept::shaped_evaluator_reduction_expression<decltype(
      expr4)>());
  REQUIRE(!execution_context::concept::flat_evaluator_reduction_expression<decltype(
      expr4)>());
  REQUIRE(!execution_context::concept::flat_evaluator_expression<decltype(expr4)>());
